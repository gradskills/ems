  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="overflow-hidden">
        <TableShell head={<><th className="px-4 py-3">Campaign</th><th className="px-4 py-3">Client</th><th className="px-4 py-3">Channel</th><th className="px-4 py-3">Status</th><th className="px-4 py-3">Reach</th><th className="px-4 py-3">Eng.</th><th className="px-4 py-3">Leads</th><th className="px-4 py-3">Spend</th></>}>
          {campaigns.map((c) => (
